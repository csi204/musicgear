  ...
  return (
    <div ref={containerRef} className={cn("relative w-full", className)}>
      ...
      <button
        ...
        className={cn(
          "w-full pl-4 pr-2 py-3 text-sm rounded-lg border border-zinc-700 bg-[#2a2a2d] text-white focus:outline-none focus:ring-2 focus:ring-amber-500/30 transition-all text-left flex items-center cursor-pointer gap-2",
          triggerClassName
        )}
      >
          ...
          <button
            ...
            className={cn(
              ...
              opt.value === value
                ...
                : "text-zinc-800 dark:text-zinc-200 hover:bg-[#ff8a3d]/20 hover:text-amber-50"
            )}
          >
            {opt.label}
          </button>
