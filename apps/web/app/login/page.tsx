    ...
    <div className="flex items-center justify-center min-h-svh p-6 bg-background">
      <div className="w-full max-w-sm space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-sm text-muted-foreground">เพื่อประสบการณ์การช้อปปิ้งที่ดีที่สุด</p>
        </div>
        ...
        <Button variant="outline" type="button" className="w-full relative flex items-center justify-center gap-2" onClick={handleGoogleLogin}>
