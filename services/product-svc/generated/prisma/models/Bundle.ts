...
export type BundleWhereInput = {
  ...
  bundleId?: Prisma.UuidFilter<"Bundle"> | string
...
export type BundleScalarWhereWithAggregatesInput = {
  ...
  bundleId?: Prisma.UuidWithAggregatesFilter<"Bundle"> | string
...
export interface BundleDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const bundleWithBundleIdOnly = await prisma.bundle.findMany({ select: { bundleId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Bundles and only return the `bundleId`
   * const bundleWithBundleIdOnly = await prisma.bundle.createManyAndReturn({
   ...
   * })
   * 
   * // Update zero or more Bundles and only return the `bundleId`
   * const bundleWithBundleIdOnly = await prisma.bundle.updateManyAndReturn({
   *   select: { bundleId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface BundleFieldRefs {
  readonly bundleId: Prisma.FieldRef<"Bundle", 'String'>
