...
export type BundleItemWhereInput = {
  ...
  bundleItemId?: Prisma.UuidFilter<"BundleItem"> | string
...
export type BundleItemScalarWhereWithAggregatesInput = {
  ...
  bundleItemId?: Prisma.UuidWithAggregatesFilter<"BundleItem"> | string
...
export type BundleItemUpdateInput = {
  bundleItemId?: Prisma.StringFieldUpdateOperationsInput | string
...
export type BundleItemOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"bundleItemId" | "bundleId" | "productId" | "quantity", ExtArgs["result"]["bundleItem"]>
...
export interface BundleItemDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * 
   * // Only select the `bundleItemId`
   * const bundleItemWithBundleItemIdOnly = await prisma.bundleItem.findMany({ select: { bundleItemId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many BundleItems and only return the `bundleItemId`
   * const bundleItemWithBundleItemIdOnly = await prisma.bundleItem.createManyAndReturn({
   *   select: { bundleItemId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   * })
   ...
   * })
   * 
   * // Update zero or more BundleItems and only return the `bundleItemId`
   * const bundleItemWithBundleItemIdOnly = await prisma.bundleItem.updateManyAndReturn({
   *   select: { bundleItemId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface BundleItemFieldRefs {
  readonly bundleItemId: Prisma.FieldRef<"BundleItem", 'String'>
