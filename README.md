...
| **3.Design** | ออกแบบโครงสร้างระบบ (System Architecture), ออกแบบฐานข้อมูลด้วย ER Diagram/Schema และออกแบบส่วนติดต่อผู้ใช้ (UI/UX) ด้วย Figma รวมถึงการทำ Sequence/Class Diagram |
