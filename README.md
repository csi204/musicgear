...
|---|---|
| **1.Planing** | ร่วมกันมองหาถึงปัญหาหลายๆอย่างที่มีและนำมาต่อยอดเป็นไอเดียในการทำระบบ และประเมินความเป็นไปได้ของโปรเจกต์ |
| **2.Analysis** | มีการวิเคราะห์ถึงปัญหาและความสำคัญของระบบนี้ กำหนดวัตถุประสงค์ ระบุขอบเขต และฟังก์ชั่นของระบบ โดยนำ UML มาใช้วิเคราะห์ เช่น Use case diagram, Class diagram, Sequence diagram  |
| **3.Design** | ออกแบบฐานข้อมูลโดยใช้ ER diagram มาช่วยออกแบบหน้าบ้านผู้ใช้โดยการนำ Figma เข้ามาช่วย ออกแบบหลังบ้านโดยใช้การออกแบบ system architecture เข้ามาช่วย |
...
| **6.Deployment** | เอาโค้ดขึ้น Production สภาพแวดล้อมระบบที่ใช้งานจริงให้ Users เข้ามาใช้ |
...
- **จัดการสต็อกสินค้าแบบเซ็ตได้ยาก:** ใบสั่งซื้อไม่ระบุตำแหน่งที่ตั้งสินค้า (Location/Bin) ของส่วนประกอบแต่ละชิ้นอย่างเป็นระบบ ทำให้พนักงานต้องเดินวนไปวนมาในคลังเพื่อหยิบของให้ครบเซ็ต
